...
OUTPUT_DIR = f"results/svm_sbert_grid_search{SUFFIX}"
SCALER_OUTPUT_PATH = os.path.join(OUTPUT_DIR, 'sbert_scaler_svm.joblib')
...
SVC_DUAL_OPTIONS = [True, False] # Or True (default) or False. False often faster when n_features > n_samples if supported by loss/penalty. 'auto' is new default.
