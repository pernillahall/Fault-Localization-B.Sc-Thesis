...
OUTPUT_DIR = f"results/lr_sbert_grid_search{SUFFIX}"
CLASSIFIER_OUTPUT_PATH = os.path.join(OUTPUT_DIR, 'lr_sbert_binary_relevance_model.joblib')
SCALER_OUTPUT_PATH = os.path.join(OUTPUT_DIR, 'sbert_scaler_lr.joblib')
X_TRAIN_OUTPUT_PATH = os.path.join(OUTPUT_DIR, 'X_train_sbert.npy')
X_VAL_OUTPUT_PATH = os.path.join(OUTPUT_DIR, 'X_val_sbert.npy')
X_TEST_OUTPUT_PATH = os.path.join(OUTPUT_DIR, 'X_test_sbert.npy')
...
# Create SBERT sentence embeddings
try:
